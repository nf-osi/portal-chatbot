...
|------------|--------|----------|----------|-----------------|---------------|--------------|---------------|-------|
| **nf-portal-chatbot** | Current | `2COISTBHRB` | `TSTALIASID` | `197` | `allaway` | [Chat](https://www.synapse.org/Chat:initialMessage=hello&agentRegistrationId=197) | [nf-portal-chatbot](https://github.com/Sage-Bionetworks/portal-agent-contexts/tree/main/nf-portal-chatbot) | Hackathon 2025/2026 version |
| **nf-portal-pilot** | Next | `WU3QRWA0FQ` | `3AOKWTCUHH` | `238` | `nf-service` | [Chat](https://www.synapse.org/Chat:initialMessage=hello&agentRegistrationId=238) | [nf-portal-pilot/](nf-portal-pilot/) | Next-gen pilot version with graph RAG |
