...
| **nf-portal-pilot** | Next | `WU3QRWA0FQ` | `3AOKWTCUHH` | `238` | `nf-service` | [Chat](https://www.synapse.org/Chat:initialMessage=hello&agentRegistrationId=238) | `nf-portal-pilot/` | Next-gen pilot version with graph RAG |
