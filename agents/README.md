...
|------------|--------|----------|----------|-----------------|---------------|--------------|---------------|-------|
| **nf-portal-pilot** | Current | `WU3QRWA0FQ` | `B0GQQL40PY` | `247` | `nf-service` | [Chat](https://www.synapse.org/Chat:initialMessage=hello&agentRegistrationId=247) | [nf-portal-pilot/](nf-portal-pilot/) | Amelia release |
...
| **nf-portal-pilot** | Next | `WU3QRWA0FQ` | `TSTALIASID` | `248` | `nf-service` | [Chat](https://www.synapse.org/Chat:initialMessage=hello&agentRegistrationId=248) | [nf-portal-pilot/](nf-portal-pilot/) | Draft/test version |
